  ...
  up: (queryInterface, Sequelize) => {
    return queryInterface.bulkInsert('Goals', [
      ...
      },
      {
        ...
        "day_average_sales_goal": "609.4150",
        "createdAt": new Date(),
        "updatedAt": new Date()
      },
      {
      ...
      },
      {
        ...
        "day_average_sales_goal": "648.2560",
        "createdAt": new Date(),
        "updatedAt": new Date()
      },
      {
        ...
        "day_average_sales_goal": "1278.1310",
        "createdAt": new Date(),
        "updatedAt": new Date()
      },
      {
      ...
      },
      {
        "Date": "2018-05-01",
        "day_average_qty_goal": "49",
        "day_average_sales_goal": "649.6310",
        "createdAt": new Date(),
        "updatedAt": new Date()
      },
      {
      ...
      },
      {
        "Date": "2018-08-01",
        "day_average_qty_goal": "99",
        "day_average_sales_goal": "1288.3810",
        "createdAt": new Date(),
        "updatedAt": new Date()
      },
      {
